      ...
      <div className="container mx-auto relative z-10 px-4 py-16 md:py-20 lg:py-24">
        ...
        >
          ...
          <div className="w-full lg:w-3/5 text-center lg:text-left">
            <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-gradient mb-4 sm:mb-6">
              Richard Hudson
            </motion.h1>
            
            <motion.h2 variants={itemVariants} className="text-xl sm:text-2xl md:text-3xl font-medium text-slate-700 dark:text-slate-300 mb-6 sm:mb-8">
              Revenue Operations Professional
            </motion.h2>
            
            <motion.p variants={itemVariants} className="text-base md:text-lg lg:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto lg:mx-0 mb-8 md:mb-10">
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap gap-4 justify-center lg:justify-start mb-12">
              <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-6 text-lg rounded-xl shadow-md hover:shadow-lg transition-all group">
                <Link href="/resume" className="flex items-center gap-2">
                  <FileText size={18} className="group-hover:scale-110 transition-transform" />
                  View Resume
                  <ArrowRight size={16} className="ml-1 transition-transform group-hover:translate-x-1.5" />
                </Link>
              </Button>
              
              <Button asChild variant="outline" size="lg" className="border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 px-6 py-6 text-lg rounded-xl group">
              ...
              <Button asChild variant="outline" size="lg" className="border-blue-600 text-blue-600 dark:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 px-6 py-6 text-lg rounded-xl group">
