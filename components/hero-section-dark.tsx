      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <Button asChild size="lg" className="bg-[#0070f3] hover:bg-[#0070f3]/90 px-6 py-6 text-lg group">
              ...
              <Button asChild variant="outline" size="lg" className="border-gray-700 text-white hover:bg-gray-800 px-6 py-6 text-lg group">
