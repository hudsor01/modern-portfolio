...
import { ContactFormData, ContactApiResponse } from '@/app/api/types'
...
export function ContactForm({
  ...
  const mutation = useMutation<ContactApiResponse, Error, ContactFormData>({ // Added types for useMutation
