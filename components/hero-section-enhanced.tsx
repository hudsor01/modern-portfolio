  ...
  return (
    <section className="h-screen w-full overflow-hidden flex items-center justify-center relative">
      ...
      <div className="absolute inset-0 overflow-hidden bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="absolute inset-0 flex flex-wrap">
          {[...Array(400)].map((_, index) => {
            ...
            const dynamicOpacity = opacity * (1 + 0.1 * Math.sin((mousePosition.x / (window.innerWidth || 1200)) * Math.PI * 2 + col * 0.2));
        ...
        >
          ...
          >
            {nameLetters.map((letter, index) => {
              ...
              if (letter === " ") {
                return <span key={index} className="w-6 sm:w-8 md:w-10">&nbsp;</span>;
              }
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle, rgba(79, 70, 229, 0.8) 0%, rgba(59, 130, 246, 0.2) 50%, transparent 80%)",
          x: springX,
          y: springY,
          translateX: "-50%",
          translateY: "-50%"
