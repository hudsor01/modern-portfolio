  ...
  const achievements = [
    {
      ...
      description: 'Spearheaded strategies resulting in significant annual revenue growth through data-driven optimization.',
      icon: BarChart2,
      color: '#0070f3',
    },
    {
      ...
      description: 'Led initiatives resulting in significant partner network growth and transaction increase.',
      icon: Users,
      color: '#0070f3',
    },
    {
