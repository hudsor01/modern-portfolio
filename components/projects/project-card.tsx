...
function ProjectCardComponent({ project, onHover }: ProjectCardProps) {
  ...
  return (
    <Card 
      className="overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col h-full border-slate-200 dark:border-slate-700 group hover:-translate-y-2 rounded-xl"
    ...
    >
      ...
      <CardHeader className="pb-2">
        ...
        <CardDescription className="mt-3 text-lg sm:text-xl text-slate-600 dark:text-slate-300">
          {project.description}
        </CardDescription>
      </CardHeader>
