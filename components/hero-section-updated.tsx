  ...
  return (
    <section className="min-h-[85vh] relative overflow-hidden py-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 left-1/3 w-96 h-96 rounded-full bg-primary/10 blur-3xl"></div>
        <div className="absolute top-1/2 left-1/4 w-48 h-48 rounded-full bg-secondary/5 blur-3xl"></div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <motion.div
                ...
                className="h-12"
              >
                <div className="relative flex items-center text-2xl md:text-3xl font-medium text-primary">
                  <span>{currentRole}</span>
                  <span className="ml-1 h-8 w-1 bg-primary animate-blink"></span>
                </div>
              </motion.div>
            </div>
            ...
            >
              <Button asChild size="lg" className="px-6 py-6 text-lg group">
              ...
              <Button asChild variant="outline" size="lg" className="px-6 py-6 text-lg group">
          ...
          >
            <div className="relative w-72 h-72 md:w-96 md:h-96">
              {/* Glowing ring effect */}
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-primary to-primary/70 blur-md p-1.5"></div>
              ...
              {/* Experience badge */}
              <div className="absolute -right-4 -bottom-2 w-24 h-24 rounded-full bg-primary backdrop-blur-sm z-10 flex flex-col items-center justify-center text-white border-2 border-white/10">
