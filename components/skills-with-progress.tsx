              ...
              {category.skills.map((skill) => (
                <div key={skill.name} className="space-y-1">
                  <div className="flex justify-between items-center">
                    <Typography variant="body2" className="text-slate-700 dark:text-slate-300 font-medium">
                      {skill.name}
                    </Typography>
                    <Tooltip 
                      title={`${skill.level}/100`} 
                      arrow
                    >
  ...
  return (
    <div className="max-w-4xl mx-auto mt-16 p-8 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-md">
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h3 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">Continuous Development</h3>
        ...
        <div className="space-y-6">
          <div className="relative">
            <div className="flex mb-1 items-center justify-between">
              <Typography variant="subtitle2" className="font-medium text-slate-700 dark:text-slate-300">
                Revenue Strategy
              </Typography>
              <Typography variant="subtitle2" className="font-medium text-blue-600 dark:text-blue-400">
                95%
              </Typography>
            </div>
            <Box sx={{ width: '100%' }}>
