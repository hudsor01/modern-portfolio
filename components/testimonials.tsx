...
const testimonials = [
  {
    quote:
      "Richard's strategic approach to revenue operations transformed our business processes, leading to a 40% increase in operational efficiency.",
    author: 'Alex Thompson',
    position: 'CEO, TechVision Inc.',
  },
  {
    quote:
      "The data-driven insights Richard provided helped us make critical business decisions that drove our company's growth by over 25% in just one year.",
    author: 'Sarah Johnson',
    position: 'COO, Elevate Solutions',
  },
  {
    quote:
      "Working with Richard on our sales pipeline optimization was eye-opening. His methodical approach uncovered opportunities we hadn't seen before.",
    author: 'Michael Chen',
