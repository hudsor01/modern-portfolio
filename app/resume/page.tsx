...
export default function ResumePage() {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 overflow-auto">
      ...
      <section className="bg-gradient-to-br from-zinc-900 via-slate-800 to-zinc-900 py-16 sm:py-20">
          ...
          {showPdf ? (
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-8 mb-8">
              <div className="flex flex-col items-center text-center gap-8">
                ...
                <p className="text-slate-600 dark:text-slate-300 mb-4 max-w-2xl text-center mx-auto">
        ...
        <section className="bg-slate-50 dark:bg-slate-800/20 py-16 px-4">
          <div className="container mx-auto max-w-5xl">
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-8">
              <h2 className="text-2xl font-bold mb-8 text-slate-900 dark:text-white flex items-center justify-center">
      ...
      {!showPdf && (
        <section className="bg-slate-50 dark:bg-slate-800/20 py-16 px-4 border-t border-slate-200 dark:border-slate-700/30">
          <div className="container mx-auto max-w-5xl">
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-8">
              <h2 className="text-2xl font-bold mb-6 text-slate-900 dark:text-white flex items-center justify-center">
                <GraduationCap className="mr-2 text-blue-600" />
                Education
              </h2>
              {education.map((edu, index) => (
                <div key={index} className="border-l-4 border-blue-600 pl-6 text-center">
                  ...
                  <p className="text-slate-600 dark:text-slate-300 text-lg">{edu.focus}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="bg-gradient-to-br from-zinc-900 via-slate-800 to-zinc-900 py-16 px-4">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-6 text-white">Ready to Connect?</h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto text-white/90">
              Interested in discussing how my skills and experience can help your team? Let&apos;s
              connect!
            </p>
            <Button
              asChild
