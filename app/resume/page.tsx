...
const skills = [
  { category: "Revenue Operations", items: ["Sales Operations", "Partner Management", "Process Optimization", "Strategic Planning"] },
  { category: "Tools & Platforms", items: ["Salesforce", "HubSpot", "SalesLoft", "PartnerStack", "Workato", "Power BI"] },
  { category: "Technical Skills", items: ["Python", "JavaScript", "React & Next.js", "SQL", "Data Visualization", "API Integrations"] }
];
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            >
              ...
              <Button variant="outline" asChild className="border-blue-600 text-blue-600 rounded-xl" size="lg">
            ...
            <div className="space-y-12">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-8 mb-8">
                <div className="flex flex-col items-center text-center gap-8">
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-2">Richard Hudson</h2>
                    <h3 className="text-xl md:text-2xl font-medium text-blue-600 dark:text-blue-400 mb-4">Revenue Operations Professional</h3>
                  </div>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-8">
                ...
                {education.map((edu, index) => (
                  <div key={index} className="border-l-4 border-blue-600 pl-6">
                    ...
                    <p className="text-lg font-medium text-blue-600 dark:text-blue-400 mb-3">{edu.institution}</p>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {skills.map((skillGroup, index) => (
                    <div key={index}>
                      <h3 className="text-lg font-semibold text-blue-600 dark:text-blue-400 mb-3">{skillGroup.category}</h3>
                      <ul className="space-y-2">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {certifications.map((cert, index) => (
                    <span key={index} className="bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 px-4 py-2 rounded-lg font-medium">
                      {cert}
                    </span>
                  ))}
                </div>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-12 text-slate-900 dark:text-white text-center border border-slate-200 dark:border-slate-700 shadow-lg">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button asChild size="lg" variant="outline" className="border-blue-600 text-blue-600 hover:bg-blue-50 dark:text-blue-400 dark:border-blue-500 dark:hover:bg-blue-900/20 rounded-xl">
                <Link href="/projects">
                  View Projects
                </Link>
              </Button>
