...
const data = leadSources.map(source => {
  // Replace "Partner Referral" with "Channel Referral"
  const adjustedName = source.source === "Partner Referral" ? "Channel Referral" : source.source;
  ...
  const handleMouseLeave = () => {
	...
	return (
		<div className='w-full max-w-3xl rounded-lg bg-white dark:bg-gray-800 p-6 shadow-lg mx-auto'>
			<h2 className='mb-4 text-xl font-semibold text-slate-800 dark:text-white'>Lead Sources</h2>
