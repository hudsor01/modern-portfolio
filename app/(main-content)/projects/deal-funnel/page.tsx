  ...
  const stageConversions = [
    {
      ...
      conversion: parseFloat(
        monthlyConversionRates[monthlyConversionRates.length - 1].lead_to_qualified.toFixed(1)
      ),
      color: '#4F46E5',
    },
    {
      ...
      conversion: parseFloat(
        monthlyConversionRates[monthlyConversionRates.length - 1].qualified_to_proposal.toFixed(1)
      ),
      color: '#8B5CF6',
    },
    {
      ...
      conversion: parseFloat(
        monthlyConversionRates[monthlyConversionRates.length - 1].proposal_to_negotiation.toFixed(1)
      ),
      color: '#EC4899',
    },
    {
      ...
      conversion: parseFloat(
        monthlyConversionRates[monthlyConversionRates.length - 1].negotiation_to_closed.toFixed(1)
      ),
      color: '#F59E0B',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Visualizing deal flow and conversion rates through the sales process
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <div className="flex justify-between mb-3">
              ...
              <span className="text-green-600 dark:text-green-400 text-xs px-2 py-1 bg-green-100 dark:bg-green-400/10 rounded-full">
                +15%
              </span>
            </div>
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">
                Visualizing drop-off at each stage
              </p>
            </div>
            ...
            {isLoading ? (
              ...
              <ResponsiveContainer width="100%" height={300}>
                ...
                >
                  ...
                  />
                  <YAxis dataKey="stage" type="category" tick={{ fill: '#64748b' }} width={150} />
                  <Tooltip
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>
                    The highest drop-off occurs between Qualified and Proposal stages with a{' '}
                    {(100 - stageConversions[1].conversion).toFixed(1)}% loss.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 mr-2 text-xs">
                  ...
                  <span>
                    Enterprise channels have the highest lead-to-close conversion at{' '}
                    {topGroups[0].lead_to_close_rate}%, despite longer sales cycles.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 mr-2 text-xs">
                  ...
                  <span>
                    The overall lead-to-close rate is{' '}
                    {((closedDeals / totalOpportunities) * 100).toFixed(1)}%, slightly above
                    industry average.
                  </span>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>
                    Implement proposal-stage enablement tools to reduce the{' '}
                    {(100 - stageConversions[1].conversion).toFixed(1)}% drop-off between
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    Optimize sales cycles for Enterprise channels, which could improve overall
                    conversion by 3-5%.
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>
                    Focus on increasing average deal size for Mid-Market channels through solution
                    bundling to improve revenue efficiency.
                  </span>
                </li>
              </ul>
            </div>
