...
export function PrevButton({ className }: SwiperButtonProps) {
	...
	return (
		<button
			className={cn(
				'group hover:bg-primary/10 rounded-full p-2.5 shadow-sm transition-colors duration-300 hover:shadow',
				className
			)}
...
export function AutoplayControl({ playing, onToggle, className }: AutoplayControlProps) {
	return (
		<button
			className={cn(
				'group hover:bg-primary/10 rounded-full p-2.5 shadow-sm transition-colors duration-300 hover:shadow',
