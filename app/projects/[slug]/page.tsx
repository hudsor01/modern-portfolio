...
// Using a custom interface for Next.js 15.2.1 compatibility
import { PageProps } from 'next/types';

interface ProjectPageProps extends Omit<PageProps, 'params'> {
	params: {
		slug: string
	}
			...
			<div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
					...
					<div className='space-y-8'>
						<section className='bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md'>
							...
							<p className='text-gray-700 dark:text-gray-300'>
								This project was developed to streamline the revenue operations process and provide better 
								visibility into key performance metrics. The solution incorporates data visualization, 
								automated reporting, and user-friendly interfaces to make complex information accessible 
				...
				<div className='space-y-8'>
					...
					<div className='bg-gradient-to-r from-[#0070f3] to-[#7461c3] rounded-xl p-8 text-white text-center shadow-lg'>
						...
						<Button asChild variant="outline" className="bg-white text-[#0070f3] hover:bg-white/90 border-white">
