                  ...
                  <Link href={`/projects/${project.slug}`}>
                    <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg border border-gray-100 dark:border-gray-700 h-full flex flex-col transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                      <div className="relative h-52 overflow-hidden">
                        ...
                        {project.featured && (
                          <div className="absolute top-4 right-4 bg-[#0070f3] text-white text-xs font-semibold px-2 py-1 rounded">
                            Featured
                          </div>
                        )}
                      ...
                      <div className="p-5 flex flex-col flex-grow">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {project.technologies?.slice(0, 3).map((tech) => (
                            <Badge key={tech} className="bg-blue-50 dark:bg-blue-900/20 text-[#0070f3] border-0">
                              {tech}
                            </Badge>
                          ))}
                          {project.technologies && project.technologies.length > 3 && (
                            <Badge className="bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 border-0">
                              +{project.technologies.length - 3}
                            </Badge>
                          )}
                        </div>
                        
                        <div className="flex items-center mt-auto text-[#0070f3] font-medium">
