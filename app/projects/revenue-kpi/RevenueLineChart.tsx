...
import { yearOverYearGrowth } from '@/app/projects/data/partner-analytics'
...
const yearlyData: ExtendedRevenueData[] = yearOverYearGrowth.map((yearData, index) => {
  const previousYear = index > 0 ? yearOverYearGrowth[index - 1] : null;
