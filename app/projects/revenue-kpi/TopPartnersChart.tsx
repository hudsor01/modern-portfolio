...
export default function TopPartnersChart() {
	return (
		<div className='rounded-lg bg-white dark:bg-gray-800 p-6 shadow-lg'>
			<h2 className='mb-4 text-xl font-semibold text-slate-800 dark:text-white'>Top 5 Partners by Revenue ($M)</h2>
        ...
        >
          <CartesianGrid strokeDasharray="3 3" horizontal={true} vertical={false} stroke="#ccc" strokeOpacity={0.3} />
					<XAxis 
            type="number"
            stroke='#64748b' 
            fontSize={12}
          ...
          >
            <LabelList dataKey="revenue" position="right" formatter={(value) => `$${value}M`} fill="#64748b" />
          </Bar>
				</BarChart>
			</ResponsiveContainer>
