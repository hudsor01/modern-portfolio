    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass rounded-2xl p-6 text-center">
          <div className="typography-h2 border-none pb-0 text-3xl text-violet-400 mb-2">96.8%</div>
          <div className="typography-small text-muted-foreground">Revenue Forecast Accuracy (Industry: 75-85%)</div>
        </div>
        <div className="glass rounded-2xl p-6 text-center">
          <div className="typography-h2 border-none pb-0 text-3xl text-purple-400 mb-2">+34.2%</div>
          <div className="typography-small text-muted-foreground">YoY Revenue Growth (Target: 25%)</div>
        </div>
        <div className="glass rounded-2xl p-6 text-center">
          <div className="typography-h2 border-none pb-0 text-3xl text-secondary mb-2">89.7%</div>
