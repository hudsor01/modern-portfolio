...
import { LazyBarChart as RechartsBarChart } from '@/components/charts/lazy-charts'
import { ResponsiveContainer, CartesianGrid, XAxis, YAxis, Tooltip, Bar, Cell } from 'recharts'
