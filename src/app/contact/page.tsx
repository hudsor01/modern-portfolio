                ...
                <div className="p-8">
                  <div className="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        <h3 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-400 via-sky-400 to-indigo-500 bg-clip-text text-transparent">Contact & Connect</h3>
                        <p className="text-sm text-gray-400">Quick ways to reach me and follow my work</p>
                      </div>
                    </div>
                ...
                <div className="p-8">
                  <div className="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-400 via-sky-400 to-indigo-500 bg-clip-text text-transparent">Office Hours</h3>
            ...
            <div className="p-8">
              <div className="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-400 via-sky-400 to-indigo-500 bg-clip-text text-transparent">Location & Service Area</h3>
                    <p className="text-sm text-gray-400">Dallas-Fort Worth • Serving clients nationwide</p>
                  </div>
                </div>
                ...
                <div className="relative w-full h-80 lg:h-96 bg-gray-900 rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 bg-[#0f172a]/95 backdrop-blur border border-white/20 rounded-xl p-3 shadow-xl">
                    ...
                    <p className="text-xs text-blue-300 font-medium">Remote & On-site Available</p>
                  </div>
                </div>
              </div>
            </div>
