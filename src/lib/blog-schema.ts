...
import { SEOSeverity, ChangeFrequency } from '@/types/seo'
...
export const seoEventCreateSchema = z.object({
  ...
  description: z.string().max(1000).optional(),
  severity: SEOSeveritySchema.default(SEOSeverity.INFO),
...
export const sitemapEntryCreateSchema = z.object({
  url: z.url(),
  lastMod: z.date(),
  changeFreq: ChangeFrequencySchema.default(ChangeFrequency.WEEKLY),
...
export type BlogPostCreateSchemaInput = z.infer<typeof blogPostCreateSchema>
export type BlogPostUpdateSchemaInput = z.infer<typeof blogPostUpdateSchema>
...
export type BlogPostFilterSchemaInput = z.infer<typeof blogPostFilterSchema>
export type BlogPostSortSchemaInput = z.infer<typeof blogPostSortSchema>
