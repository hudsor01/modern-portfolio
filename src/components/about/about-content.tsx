      ...
      <div className="container relative z-10 px-4 mx-auto max-w-7xl py-16 space-y-16">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-6 text-blue-300">
              ...
              >
                ...
                <MapPin size={16} />
                <span className="text-sm">{personalInfo?.location || 'Remote • Available Worldwide'}</span>
              </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-blue-300 via-sky-400 to-indigo-400">My Story</h2>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-blue-300 via-sky-400 to-indigo-400">Key Highlights</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Grew partner network and increased transaction volume through strategic partnership development.',
                icon: Users,
              },
              {
                value: '40%',
                label: 'Process Optimization',
                description: 'Implemented cross-functional workflow integrations, reducing processing time and improving efficiency.',
                icon: Target,
              }
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote: "Richard's data-driven approach transformed our sales process and increased conversion rates by 35% in just three months.",
                name: "Sarah Johnson",
                title: "VP of Sales, TechCorp Inc.",
                avatar: "SJ"
              },
              {
                quote: "His strategic insights helped us identify bottlenecks we didn't know existed. A true game-changer for our operations.",
                name: "Michael Chen",
                title: "COO, GrowthMetrics",
                avatar: "MC"
              },
              {
                quote: "Richard's expertise in revenue operations helped us scale our channel program to new heights. Remarkable results.",
        ...
        >
          <div className="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-8 md:p-12">
            ...
            <p className="text-gray-200 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-light mb-8">
              Ready to optimize your revenue operations and drive growth? Let's discuss how we can achieve your business goals together.
            </p>
