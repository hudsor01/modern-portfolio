...
interface ChartClickEvent extends ChartMouseEvent {
  activeCoordinate?: { x: number; y: number }
}

type ChartEventHandler = (event: ChartClickEvent) => void
type ChartMouseEventHandler = (event: ChartMouseEvent) => void
...
function ChartContainer({
  ...
  onMouseLeave?: ChartMouseEventHandler
}) {
...
function ChartTooltipContent({
  ...
  labelFormatter?: (value: string | number, payload: ChartTooltipPayload[]) => React.ReactNode
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      <div className="grid gap-1.5">
                        {nestLabel ? tooltipLabel : null}
                        <span className="typography-muted">{itemConfig?.label || item.name}</span>
                      </div>
                      {item.value && (
