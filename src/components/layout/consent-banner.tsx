      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-[525px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Customize your cookie preferences below. Necessary cookies are required for the
            ...
            {consentOptions.map((option) => (
              <div key={option.id} className="flex items-start space-x-3">
                <Checkbox
                  ...
                  {...(!option.disabled && {
                    onCheckedChange: () =>
                      handleCheckboxChange(option.id as Exclude<ConsentType, 'necessary'>),
                  })}
