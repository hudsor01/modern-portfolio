...
export class ExperienceError extends Error {
  code: number;
  details?: z.ZodFormattedError<Record<string, unknown>> | Record<string, unknown>;

  constructor(message: string, code: number = 400, details?: z.ZodFormattedError<Record<string, unknown>> | Record<string, unknown>) {
    super(message);
